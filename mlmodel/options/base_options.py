...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        #parser.add_argument('--dataroot', default='./test_imgs', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='mlmodel/checkpoints', help='models are saved here')
        # model parameters
